...
class RobokassaPayment extends OffsitePaymentGatewayBase implements RobokassaPaymentInterface
{
    ...
    public function buildConfigurationForm(array $form, FormStateInterface $form_state)
    {
        ...
        $form['robokassa_iframe'] = [
            '#type' => 'select',
            '#title' => $this->t('IFrame'),
            '#description' => t('Внимание! При включённом iframe, способов оплаты меньше, чем на обычной платежной странице.'),
            '#options' => [
                '0' => 'Выключено',
                '1' => 'Включено',
            ],
            '#default_value' => $this->configuration['robokassa_iframe'],
            '#required' => TRUE,
        ];
        ...
        $form['tax'] = [
            ...
            '#options' => [
                ...
                'vat105' => 'НДС чека по расчетной ставке 7/107',
...
//    ];
    ...
    public function submitConfigurationForm(array &$form, FormStateInterface $form_state)
    {
        ...
        if (!$form_state->getErrors()) {
            ...
            $this->configuration['robokassa_iframe'] = $values['robokassa_iframe'];
